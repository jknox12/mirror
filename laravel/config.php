...
class Config {
	 ...
	 * @var array
	 */
	public static $paths = array(SYS_CONFIG_PATH, GLOBAL_CONFIG_PATH, ENV_GLOBAL_CONFIG_PATH, CONFIG_PATH, ENV_CONFIG_PATH);
	...
	public static function load($file)
	{
		...
		foreach (static::$paths as $directory)
		{
			...
			{
				$config = array_overwrite_merge_recursive($config, require $path);
			}
		}
	...
	/**
     * Created by Tienda Nube to unify API of Laravel v1.5 and v2
     */
