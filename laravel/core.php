...
define('GLOBAL_CONFIG_PATH', realpath(MWP_SERVICE_PATH . '/../config').'/');
define('CONTROLLER_PATH', APP_PATH.'controllers/');
define('DATABASE_PATH', STORAGE_PATH.'database/');
define('LANG_PATH', APP_PATH.'languages/');
define('LIBRARY_PATH', MWP_SERVICE_PATH.'lib/');
//define('MODEL_PATH', MWP_CORE_PATH.'models/');
...
if (isset($env))
{
	...
	$environmentGlobal = GLOBAL_CONFIG_PATH.$env.'/';
}

define('ENV_CONFIG_PATH', $environment);
define('ENV_GLOBAL_CONFIG_PATH', $environmentGlobal);

unset($application, $public, $laravel, $environment, $environmentGlobal);
...
//	'Laravel\\IoC' => SYS_PATH.'ioc'.EXT,
	...
	'System\\Redis' => MWP_SERVICE_PATH.'eloquent/system/redis'.EXT,
